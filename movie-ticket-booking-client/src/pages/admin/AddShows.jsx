  ...
  return nowPlayingMovies.length > 0 ? (
    <>
      ...
      <div className="overflow-x-auto pb-4">
        <div className="group flex flex-wrap w-max gap-4 mt-4">
              ...
              <div className="relative rounded-lg overflow-hidden">
                ...
                <div className="text-sm flex items-center justify-between p-2 bg-black/70 w-full absolute bottom-0 left-0">
                  <p className="flex items-center gap-1">
                    <StarIcon className="text-[#F84565] fill-[#F84565] w-4 h-4" />
      ...
      <div className="mt-8">
        <label htmlFor="" className="block text-sm font-medium mb-2">Show Price</label>
          <div className="inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md">
            ...
            <input type="number" value={showPrice} min={0} onChange={(e)=> setShowPrice(e.target.value)} placeholder="Enter show price" className="outline-none" />
